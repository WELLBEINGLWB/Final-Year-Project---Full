...
"""autogenerated by genpy from segmentation/gazeOptimiserRequest.msg. Do not edit."""
import sys
...
class gazeOptimiserRequest(genpy.Message):
  _md5sum = "2f72d8b702c082480674a6c1662c60e7"
  _type = "segmentation/gazeOptimiserRequest"
...
float64 z
"""
  __slots__ = ['objects','gaze_point']
  _slot_types = ['std_msgs/Float32MultiArray','geometry_msgs/Point']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(gazeOptimiserRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3d.pack(_x.gaze_point.x, _x.gaze_point.y, _x.gaze_point.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.gaze_point.x, _x.gaze_point.y, _x.gaze_point.z,) = _struct_3d.unpack(str[start:end])
      return self
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from segmentation/gazeOptimiserResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class gazeOptimiserResponse(genpy.Message):
  _md5sum = "5d1799e0b491e3c6d6f148bd3d07bda9"
  _type = "segmentation/gazeOptimiserResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(gazeOptimiserResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
class gazeOptimiser(object):
  _type          = 'segmentation/gazeOptimiser'
  _md5sum = '8797234007ca66fde932e9a1f8ff3b3b'
  _request_class  = gazeOptimiserRequest
  _response_class = gazeOptimiserResponse
