...
"""autogenerated by genpy from natnet_msgs/MarkerList.msg. Do not edit."""
import sys
...
class MarkerList(genpy.Message):
  _md5sum = "acdfedb917425498ce6df7299be88b7c"
  _type = "natnet_msgs/MarkerList"
...
float64 y
float64 z"""
  __slots__ = ['header','ids','positions']
  _slot_types = ['std_msgs/Header','int32[]','geometry_msgs/Vector3[]']
