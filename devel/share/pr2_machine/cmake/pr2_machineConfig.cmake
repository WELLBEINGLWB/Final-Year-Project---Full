...
if("TRUE" STREQUAL "TRUE")
  set(pr2_machine_SOURCE_PREFIX /home/faisallab008/catkin_ws/src/pr2_common/pr2_machine)
  set(pr2_machine_DEVEL_PREFIX /home/faisallab008/catkin_ws/devel)
  ...
  set(pr2_machine_INSTALL_PREFIX /home/faisallab008/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pr2_machine' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ROS Orphaned Package Maintainers <ros-orphaned-packages@googlegroups.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'pr2_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/faisallab008/catkin_ws/src/pr2_common/pr2_machine/${idir}'.  Ask the maintainer 'ROS Orphaned Package Maintainers <ros-orphaned-packages@googlegroups.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${pr2_machine_dep}_FOUND)
      find_package(${pr2_machine_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pr2_machine_dep} REQUIRED ${depend_list})
  endif()
