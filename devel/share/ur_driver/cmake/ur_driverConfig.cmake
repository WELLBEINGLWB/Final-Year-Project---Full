...
if("TRUE" STREQUAL "TRUE")
  set(ur_driver_SOURCE_PREFIX /home/faisallab008/catkin_ws/src/universal_robot/ur_driver)
  set(ur_driver_DEVEL_PREFIX /home/faisallab008/catkin_ws/devel)
  ...
  set(ur_driver_INSTALL_PREFIX /home/faisallab008/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ur_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Nadia Hammoudeh Garcia <nhg@ipa.fhg.de>, G.A. vd. Hoorn <g.a.vanderhoorn@tudelft.nl>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ur_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/faisallab008/catkin_ws/src/universal_robot/ur_driver/${idir}'.  Ask the maintainer 'Nadia Hammoudeh Garcia <nhg@ipa.fhg.de>, G.A. vd. Hoorn <g.a.vanderhoorn@tudelft.nl>' to fix it.")
    endif()
