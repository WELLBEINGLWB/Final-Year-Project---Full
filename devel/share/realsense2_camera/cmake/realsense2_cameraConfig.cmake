...
if("TRUE" STREQUAL "TRUE")
  set(realsense2_camera_SOURCE_PREFIX /home/faisallab008/catkin_ws/src/realsense/realsense2_camera)
  set(realsense2_camera_DEVEL_PREFIX /home/faisallab008/catkin_ws/devel)
  ...
  set(realsense2_camera_INSTALL_PREFIX /home/faisallab008/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'realsense2_camera' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Sergey Dorodnicov <sergey.dorodnicov@intel.com>, Doron Hirshberg <doron.hirshberg@intel.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'realsense2_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/faisallab008/catkin_ws/src/realsense/realsense2_camera/${idir}'.  Ask the maintainer 'Sergey Dorodnicov <sergey.dorodnicov@intel.com>, Doron Hirshberg <doron.hirshberg@intel.com>' to fix it.")
    endif()
...
set(realsense2_camera_EXPORTED_TARGETS "realsense2_camera_generate_messages_cpp;realsense2_camera_generate_messages_lisp;realsense2_camera_generate_messages_py;realsense2_camera_gencfg")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${realsense2_camera_dep}_FOUND)
      find_package(${realsense2_camera_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${realsense2_camera_dep} REQUIRED ${depend_list})
  endif()
