...
if("TRUE" STREQUAL "TRUE")
  set(moveit_tutorials_SOURCE_PREFIX /home/faisallab008/catkin_ws/src/moveit_tutorials)
  set(moveit_tutorials_DEVEL_PREFIX /home/faisallab008/catkin_ws/devel)
  ...
  set(moveit_tutorials_INSTALL_PREFIX /home/faisallab008/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/faisallab008/catkin_ws/src/moveit_tutorials/${idir}'.  Ask the maintainer 'Dave Coleman <dave@dav.ee>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${moveit_tutorials_dep}_FOUND)
      find_package(${moveit_tutorials_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${moveit_tutorials_dep} REQUIRED ${depend_list})
  endif()
