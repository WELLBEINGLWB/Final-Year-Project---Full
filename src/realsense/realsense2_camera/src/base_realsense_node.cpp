...
// N
// void myPublisher(const ros::Time& t)
// {
...
//
//     sensor_msgs::PointCloud2Iterator<float>iter_x(msg_pointcloud_test, "x");
//     sensor_msgs::PointCloud2Iterator<float>iter_y(msg_pointcloud_test, "y");
//     sensor_msgs::PointCloud2Iterator<float>iter_z(msg_pointcloud_test, "z");
//
//     sensor_msgs::PointCloud2Iterator<uint8_t>iter_r(msg_pointcloud_test, "r");
//     sensor_msgs::PointCloud2Iterator<uint8_t>iter_g(msg_pointcloud_test, "g");
//     sensor_msgs::PointCloud2Iterator<uint8_t>iter_b(msg_pointcloud_test, "b");
//
...
//         }
//     }
//     _pointcloud_publisher.publish(msg_pointcloud_test);
// }
