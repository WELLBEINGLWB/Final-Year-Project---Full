...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/faisallab008/catkin_ws/install/${idir}'.  Ask the maintainer 'Dave Coleman <dave@dav.ee>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
